...
rewash_tasks_table = db.table("rewash_tasks")
rewash_recheck_records_table = db.table("rewash_recheck_records")
delivery_records_table = db.table("delivery_records")
...
RewashTaskQuery = Query()
RewashRecheckQuery = Query()
DeliveryRecordQuery = Query()
